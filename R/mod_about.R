...
mod_about_ui <- function(id) {
  ...
  tagList(
    ...
    p(
      style = "text-align:justify", "To best of our knowledge, the web application provided here presents the only non-governmental estimate of the effective reproduction number \\(R_t\\).",
